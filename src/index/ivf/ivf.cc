...
// fp16
KNOWHERE_MOCK_REGISTER_GLOBAL(IVFFLAT, IvfIndexNode, fp16, fp32, faiss::IndexIVFFlat);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVF_FLAT, IvfIndexNode, fp16, fp32, faiss::IndexIVFFlat);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVFFLATCC, IvfIndexNode, fp16, fp32, faiss::IndexIVFFlatCC);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVF_FLAT_CC, IvfIndexNode, fp16, fp32, faiss::IndexIVFFlatCC);
KNOWHERE_MOCK_REGISTER_GLOBAL(SCANN, IvfIndexNode, fp16, fp32, faiss::IndexScaNN);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVFPQ, IvfIndexNode, fp16, fp32, faiss::IndexIVFPQ);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVF_PQ, IvfIndexNode, fp16, fp32, faiss::IndexIVFPQ);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVFSQ, IvfIndexNode, fp16, fp32, faiss::IndexIVFScalarQuantizer);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVF_SQ8, IvfIndexNode, fp16, fp32, faiss::IndexIVFScalarQuantizer);
// bf16
KNOWHERE_MOCK_REGISTER_GLOBAL(IVFFLAT, IvfIndexNode, bf16, fp32, faiss::IndexIVFFlat);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVF_FLAT, IvfIndexNode, bf16, fp32, faiss::IndexIVFFlat);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVFFLATCC, IvfIndexNode, bf16, fp32, faiss::IndexIVFFlatCC);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVF_FLAT_CC, IvfIndexNode, bf16, fp32, faiss::IndexIVFFlatCC);
KNOWHERE_MOCK_REGISTER_GLOBAL(SCANN, IvfIndexNode, bf16, fp32, faiss::IndexScaNN);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVFPQ, IvfIndexNode, bf16, fp32, faiss::IndexIVFPQ);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVF_PQ, IvfIndexNode, bf16, fp32, faiss::IndexIVFPQ);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVFSQ, IvfIndexNode, bf16, fp32, faiss::IndexIVFScalarQuantizer);
KNOWHERE_MOCK_REGISTER_GLOBAL(IVF_SQ8, IvfIndexNode, bf16, fp32, faiss::IndexIVFScalarQuantizer);
}  // namespace knowhere

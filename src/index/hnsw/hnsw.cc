...
class HnswIndexNode : public IndexNode {
 ...
 public:
    expected<std::vector<std::shared_ptr<typename knowhere::IndexNode::iterator>>>
...
KNOWHERE_MOCK_REGISTER_GLOBAL(HNSW, HnswIndexNode, fp16, fp32);
KNOWHERE_MOCK_REGISTER_GLOBAL(HNSW, HnswIndexNode, bf16, fp32);
}  // namespace knowhere

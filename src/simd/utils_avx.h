...
_mm256_reduce_add_ps(const __m256 res) {
    return horizontal_sum(res);
}

// 8x2 -> 2x8
inline void
transpose_8x2(const __m256 i0, const __m256 i1, __m256& o0, __m256& o1) {
...
// 8x4 -> 4x8
inline void
transpose_8x4(const __m256 i0, const __m256 i1, const __m256 i2, const __m256 i3, __m256& o0, __m256& o1, __m256& o2,
              __m256& o3) {
...
inline void
transpose_8x8(const __m256 i0, const __m256 i1, const __m256 i2, const __m256 i3, const __m256 i4, const __m256 i5,
              const __m256 i6, const __m256 i7, __m256& o0, __m256& o1, __m256& o2, __m256& o3, __m256& o4, __m256& o5,
              __m256& o6, __m256& o7) {
    // say, we have the following as an input:

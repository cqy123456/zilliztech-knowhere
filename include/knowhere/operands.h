...
// define result type, in case use double or uint8 data type in the future
...
struct ResultType<
    DataType, std::enable_if_t<std::is_same_v<DataType, knowhere::fp32> || std::is_same_v<DataType, knowhere::fp16> ||
                               std::is_same_v<DataType, knowhere::bf16> || std::is_same_v<DataType, knowhere::bin1>>> {
    using type = knowhere::fp32;
};

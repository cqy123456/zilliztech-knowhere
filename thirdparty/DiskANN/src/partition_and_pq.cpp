...
template void gen_random_slice<int8_t>(const int8_t *inputdata, size_t npts,
                                       ...
                                       float *&sampled_data,
                                       size_t &slice_size);
template void gen_random_slice<knowhere::fp16>(const knowhere::fp16 *inputdata,
                                               size_t npts, size_t ndims,
                                               double  p_val,
                                               float *&sampled_data,
                                               size_t &slice_size);
template void gen_random_slice<knowhere::bf16>(const knowhere::bf16 *inputdata,
                                               size_t npts, size_t ndims,
                                               double  p_val,
                                               float *&sampled_data,
                                               size_t &slice_size);
...
template void gen_random_slice<int8_t>(const std::string data_file,
                                       double p_val, float *&sampled_data,
                                       size_t &slice_size, size_t &ndims);
template void gen_random_slice<knowhere::fp16>(const std::string data_file,
                                               double            p_val,
                                               float           *&sampled_data,
                                               size_t           &slice_size,
                                               size_t           &ndims);
template void gen_random_slice<knowhere::bf16>(const std::string data_file,
                                               double            p_val,
                                               float           *&sampled_data,
                                               size_t           &slice_size,
                                               size_t           &ndims);
